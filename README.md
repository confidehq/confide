...
- **🔑 Passkey-Powered:** Modern, passwordless authentication with native key management. Uses WebAuthn for authentication meaning no passwords or email required.
...
- **📝 Seamless Collaboration:** Workspaces are fully encrypted for all members, teammates can share and access data without ever having to manually manage, copy, or exchange cryptographic keys.
