...
ALTER TABLE workspace_invitations
    DROP CONSTRAINT IF EXISTS workspace_invitations_invited_by_account_id_fkey,
...
ALTER TABLE workspace_member_keys
    DROP CONSTRAINT IF EXISTS workspace_member_keys_granted_by_account_id_fkey,
...
ALTER TABLE forms
    DROP CONSTRAINT IF EXISTS forms_created_by_account_id_fkey,
