...
let steps = $state<Step[]>([
	...
	{
		id: 2,
		title: "Registration: wrapKey with PRF output",
		status: "pending",
		detail: "",
		expanded: false,
	},
	{
		id: 3,
		title: "Assertion: unwrapKey determinism",
		status: "pending",
		detail: "",
		expanded: false,
	},
	{
		id: 4,
		title: "Full Key Hierarchy: encryptResponse / decryptResponse",
		status: "pending",
		detail: "",
		expanded: false,
	},
	{
		id: 5,
		title: "Recovery Flow: deriveRecoveryKey + wrap/unwrap",
		status: "pending",
		detail: "",
		expanded: false,
	},
	{
		id: 6,
		title: "Hash Verification: hashForVerification",
		status: "pending",
		detail: "",
		expanded: false,
	},
...
async function step2(): Promise<string> {
	...
	simulatedPrfOutput = crypto.getRandomValues(
		new Uint8Array(32),
...
async function step4(): Promise<string> {
	...
	const schemaMatches =
		JSON.stringify(recoveredSchema) === JSON.stringify(sampleSchema);
