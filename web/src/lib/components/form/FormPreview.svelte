...
<div class="max-w-[600px] mt-10 mx-auto px-6 pb-20 font-[system-ui,sans-serif] text-form-text">
	<!-- Preview banner -->
	<div class="mb-6 px-3.5 py-2 bg-form-preview-bg border border-form-preview-border rounded-md text-xs text-form-preview-text">
	...
	<div class="flex justify-between items-center mt-8">
		...
		{:else}
			<button
				type="button"
				disabled
				class="px-6 py-2.5 bg-form-muted-light text-white border-none rounded-md text-sm font-[inherit] cursor-not-allowed"
			>
				Submit
			</button>
		{/if}
